// Inline icon table and SVG helpers used by the reader UI.
...
export function iconLabel(host, name, text) {
...
function icon(n) {
  ...
  const m = {
    ...
    // Paperclip and image, for the AI attachment entry.
